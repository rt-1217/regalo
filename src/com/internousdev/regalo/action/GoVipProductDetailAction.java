...
public class GoVipProductDetailAction extends ActionSupport implements SessionAware{
	...
	public String execute() {
		...
		VipProductInfoDAO VipProductInfoDAO = new VipProductInfoDAO();

		//商品リスト
		productInfoList = VipProductInfoDAO.getVipProductInfoByProductId(productId);

		session.put("productInfoList", productInfoList);

		//関連商品リスト
		relationList = VipProductInfoDAO.getVipProductInfoByCategoryId(productInfoList.get(0).getCategoryId());
